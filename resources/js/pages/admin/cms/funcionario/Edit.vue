    ...
    >
        ...
        >
            ...
            <inertia-link
                ...
                "
                :href="$route('admin.cms.funcionarios.index')"
            >
                <icon-chevron-left
                    class="w-5 md:mr-2"
                />
        ...
        <div class="bg-white py-6 shadow-subtle rounded-lg">
            <div class="block px-6 w-full">
                ...
                <div class="extraOutline bg-white w-max bg-whtie rounded-lg mt-5">
                    <p class="text-lg">Imagem de capa</p>
                    ...
                    <label v-if="filePreview != null" class="mt-5">
                        <input class="text-sm cursor-pointer w-36 hidden" ref="fileInput"
                            type="file"
                            id="formFileLg"
                            @input="selectImgFile">
                        <div class="text bg-indigo-600 text-white border border-gray-300 rounded font-semibold cursor-pointer p-1 px-3 hover:bg-indigo-500">Selecione para alterar</div>
                    </label>
                </div>
            </div>
        </div>
