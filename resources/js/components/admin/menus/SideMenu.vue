                ...
                menu: {
                    ...
                    cms: {
                        children : {
                            ...
                            depoimentos: {
                                activeRoutes: ["admin.cms.depoimentos.index", "admin.cms.depoimentos.create", "admin.cms.depoimentos.edit"],
                                children: {
                                    index: {
                                        icon: false,
                                        ...
                                        requiresAllPermissions: ["cms.view"],
                                        requiresAnyPermissions: [],
                                        route: "admin.cms.depoimentos.index",
                                    },
                                    create: {
                                        children: false,
                                        icon: false,
                                        label: "Cadastrar Depoimento",
                                        requiresAllPermissions: ["cms.create"],
                                        requiresAnyPermissions: [],
                                        route: "admin.cms.depoimentos.create",
                                    },
                                },
                                icon: "icon-users",
                                label: "Depoimentos",
